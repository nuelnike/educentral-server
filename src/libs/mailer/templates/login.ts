import { logo, base_url, support, physical_address, company } from '../../../core/data/system-info';
export const Template = (payload:any):string => { 
    return `
                                                                    ...
                                                                    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                                                        <tr>
                                                                            <td align="center" bgcolor="#009EF7" role="presentation" style="border:none;border-radius:3px;color:#ffffff;cursor:auto;padding:15px 25px;" valign="middle">
                                                                                <a href="${base_url +`/auth/lock-account?ref=`+payload.lock}" style="background:#009EF7;color:#ffffff;font-family:'Helvetica Neue',Arial,sans-serif;font-size:15px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;">
