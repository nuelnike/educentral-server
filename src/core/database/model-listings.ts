...
const Package_tier = SelectModel("package_tiers");
...
Subscription.belongsTo(Package_tier, { foreignKey: "package_tier_id" });

Package.hasMany(Package_tier, { foreignKey: "package_id" });
Package_tier.belongsTo(Package, { foreignKey: "package_id" });

Package_tier.hasMany(Subscription, { foreignKey: "package_tier_id" });
